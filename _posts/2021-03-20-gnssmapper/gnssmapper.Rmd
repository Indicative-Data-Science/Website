...
author:
  - name: Terrence Lines
    url: {https://www.gla.ac.uk/schools/ges/staff/terencelines/}
date: 03-20-2021
categories:
  - GNSS-Mapping
tags:
...
```{r, echo=F, fig.align='center', fig.cap="example 3D map", out.width = '30%'}
knitr::include_graphics("https://user-images.githubusercontent.com/43879942/116072219-bbb59480-a686-11eb-9d66-828b84286365.png")
```


<!--![example 3D map](https://user-images.githubusercontent.com/43879942/116072219-bbb59480-a686-11eb-9d66-828b84286365.png)-->

What would be stopping you (because of course that's something you'd want to do)? Well, I guess for most people, the problem is that creating the map would require some working knowledge of all the below: <br>
1) GNSS systems <br>
2) GIS / geospatial data science <br>
3) computer vision, in particular multi-view stereo 
...
Grab the [package](https://pypi.org/project/gnssmapper/) and [documentation](https://gnssmapper.readthedocs.io/en/latest/) and read on.


Making your first map
=======================

So first off, install the package using pip, but taking care to follow our [instructions](https://gnssmapper.readthedocs.io/en/latest/getting_started/installation.html) (this is probably the most difficult bit of the tutorial).
...
1. Obtain [GnssLogger](https://play.google.com/store/apps/details?id=com.google.android.apps.location.gps.gnsslogger) for your phone from the Android Play store. This is a Google developed app for showcasing the ability of using GNSS data.
...
The dataframe will also include all the various raw data that GNSSLogger outputs (as described in the [Android documentation](https://developer.android.com/guide/topics/sensors/gnss)) but for now, lets focus on two key ones:
...
The Receiverpoints object is a GeoPandas DataFrame, so can use all its normal methods for geospatial data handling. If you are new to GeoPandas, you may wish to [familarise yourself](https://geopandas.org/getting_started/introduction.html) with its core concepts.
...
For the rest of the tutorial, we'll use a [receiverpoint file](https://github.com/Indicative-Data-Science/gnssmapper/blob/master/examplefiles/pilot_study.geojson.zip) created as part of a pilot study.
```
    >>> import geopandas as gpd
...
```{r, echo=F, fig.align='center', fig.cap="Graph of algorithm ", out.width = '30%'}
knitr::include_graphics("https://user-images.githubusercontent.com/43879942/116072223-bc4e2b00-a686-11eb-849a-d8c80ff6bea6.png")
```
